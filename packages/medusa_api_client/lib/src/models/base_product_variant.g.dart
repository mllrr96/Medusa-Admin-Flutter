...
part of 'base_product_variant.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

_$BaseProductVariantImpl _$$BaseProductVariantImplFromJson(
  Map<String, dynamic> json,
) => _$BaseProductVariantImpl(
  ...
  options: (json['options'] as List<dynamic>)
      .map((e) => BaseProductOptionValue.fromJson(e as Map<String, dynamic>))
      .toList(),
...
Map<String, dynamic> _$$BaseProductVariantImplToJson(
  _$BaseProductVariantImpl instance,
) => <String, dynamic>{
  'id': instance.id,
