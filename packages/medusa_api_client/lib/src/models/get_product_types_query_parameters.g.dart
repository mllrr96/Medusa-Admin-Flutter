...
_GetProductTypesQueryParameters _$GetProductTypesQueryParametersFromJson(
...
Map<String, dynamic> _$GetProductTypesQueryParametersToJson(
  _GetProductTypesQueryParameters instance,
) => <String, dynamic>{
