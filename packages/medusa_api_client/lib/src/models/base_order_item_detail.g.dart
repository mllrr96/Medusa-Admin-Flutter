...
_$BaseOrderItemDetailImpl _$$BaseOrderItemDetailImplFromJson(
  Map<String, dynamic> json,
) => _$BaseOrderItemDetailImpl(
  ...
  returnRequestedQuantity: (json['return_requested_quantity'] as num)
      .toDouble(),
  returnReceivedQuantity: (json['return_received_quantity'] as num).toDouble(),
...
Map<String, dynamic> _$$BaseOrderItemDetailImplToJson(
  _$BaseOrderItemDetailImpl instance,
) => <String, dynamic>{
  'id': instance.id,
