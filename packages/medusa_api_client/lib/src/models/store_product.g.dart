...
_StoreProduct _$StoreProductFromJson(Map<String, dynamic> json) =>
    _StoreProduct(
      categories: (json['categories'] as List<dynamic>)
          ...
          .toList(),
      type: StoreProductType.fromJson(json['type'] as Map<String, dynamic>),
      length: (json['length'] as num).toDouble(),
      title: json['title'] as String,
      status: $enumDecode(_$NullEnumEnumMap, json['status']),
      options: (json['options'] as List<dynamic>)
          .map((e) => StoreProductOption.fromJson(e as Map<String, dynamic>))
          .toList(),
      ...
      variants: (json['variants'] as List<dynamic>)
          .map((e) => StoreProductVariant.fromJson(e as Map<String, dynamic>))
          .toList(),
      ...
      images: (json['images'] as List<dynamic>)
          .map((e) => StoreProductImage.fromJson(e as Map<String, dynamic>))
          .toList(),
