...
_$OrderChangeActionImpl _$$OrderChangeActionImplFromJson(
  Map<String, dynamic> json,
) => _$OrderChangeActionImpl(
...
Map<String, dynamic> _$$OrderChangeActionImplToJson(
  _$OrderChangeActionImpl instance,
) => <String, dynamic>{
  'id': instance.id,
