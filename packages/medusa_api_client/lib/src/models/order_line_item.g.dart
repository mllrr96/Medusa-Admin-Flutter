...
_OrderLineItem _$OrderLineItemFromJson(
  ...
  taxLines: (json['tax_lines'] as List<dynamic>)
      .map((e) => OrderLineItemTaxLine.fromJson(e as Map<String, dynamic>))
      .toList(),
  adjustments: (json['adjustments'] as List<dynamic>)
      .map((e) => OrderLineItemAdjustment.fromJson(e as Map<String, dynamic>))
      .toList(),
  detail: OrderItem.fromJson(json['detail'] as Map<String, dynamic>),
