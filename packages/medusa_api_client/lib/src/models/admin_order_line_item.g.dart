...
_$AdminOrderLineItemImpl _$$AdminOrderLineItemImplFromJson(
  Map<String, dynamic> json,
) => _$AdminOrderLineItemImpl(
  ...
  product: AdminProduct.fromJson(json['product'] as Map<String, dynamic>),
...
Map<String, dynamic> _$$AdminOrderLineItemImplToJson(
  _$AdminOrderLineItemImpl instance,
) => <String, dynamic>{
  'id': instance.id,
