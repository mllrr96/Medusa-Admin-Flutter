...
_$AdminOrderPreviewImpl _$$AdminOrderPreviewImplFromJson(
  Map<String, dynamic> json,
) => _$AdminOrderPreviewImpl(
...
Map<String, dynamic> _$$AdminOrderPreviewImplToJson(
  _$AdminOrderPreviewImpl instance,
) => <String, dynamic>{
