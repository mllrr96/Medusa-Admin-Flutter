...
part of 'store_order_line_item.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

_$StoreOrderLineItemImpl _$$StoreOrderLineItemImplFromJson(
  Map<String, dynamic> json,
) => _$StoreOrderLineItemImpl(
  id: json['id'] as String,
  title: json['title'] as String,
  subtitle: json['subtitle'] as String,
  thumbnail: json['thumbnail'] as String,
  variant: StoreProductVariant.fromJson(
...
Map<String, dynamic> _$$StoreOrderLineItemImplToJson(
  _$StoreOrderLineItemImpl instance,
) => <String, dynamic>{
  'id': instance.id,
