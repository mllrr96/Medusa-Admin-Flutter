...
_$StoreCreateReturnImpl _$$StoreCreateReturnImplFromJson(
  Map<String, dynamic> json,
) => _$StoreCreateReturnImpl(
...
Map<String, dynamic> _$$StoreCreateReturnImplToJson(
  _$StoreCreateReturnImpl instance,
) => <String, dynamic>{
