...
/// }
library store_cart_shipping_method;

import 'exports.dart';
part 'store_cart_shipping_method.freezed.dart';
part 'store_cart_shipping_method.g.dart'; // StoreCartShippingMethod

@freezed
abstract class StoreCartShippingMethod with _$StoreCartShippingMethod {
  const StoreCartShippingMethod._();

  @jsonSerializable
  const factory StoreCartShippingMethod({
    /// id
    @JsonKey(name: StoreCartShippingMethod.idKey) required String id,

    /// cartId
    @JsonKey(name: StoreCartShippingMethod.cartIdKey) required String cartId,

    /// name
    @JsonKey(name: StoreCartShippingMethod.nameKey) required String name,

    /// description
    @JsonKey(name: StoreCartShippingMethod.descriptionKey)
    required String description,

    /// amount
    @JsonKey(name: StoreCartShippingMethod.amountKey) required double amount,

    /// isTaxInclusive
    @JsonKey(name: StoreCartShippingMethod.isTaxInclusiveKey)
    required bool isTaxInclusive,

    /// shippingOptionId
    @JsonKey(name: StoreCartShippingMethod.shippingOptionIdKey)
    required String shippingOptionId,

    /// data
    @JsonKey(name: StoreCartShippingMethod.dataKey)
    required Map<String, dynamic> data,

    /// metadata
    @JsonKey(name: StoreCartShippingMethod.metadataKey)
    required Map<String, dynamic> metadata,

    /// taxLines
    @JsonKey(name: StoreCartShippingMethod.taxLinesKey)
    required List<dynamic> taxLines,

    /// adjustments
    @JsonKey(name: StoreCartShippingMethod.adjustmentsKey)
    required List<dynamic> adjustments,

    /// createdAt
    @JsonKey(name: StoreCartShippingMethod.createdAtKey)
    required DateTime createdAt,

    /// updatedAt
    @JsonKey(name: StoreCartShippingMethod.updatedAtKey)
    required DateTime updatedAt,

    /// originalTotal
    @JsonKey(name: StoreCartShippingMethod.originalTotalKey)
    required double originalTotal,

    /// originalSubtotal
    @JsonKey(name: StoreCartShippingMethod.originalSubtotalKey)
    required double originalSubtotal,

    /// originalTaxTotal
    @JsonKey(name: StoreCartShippingMethod.originalTaxTotalKey)
    required double originalTaxTotal,

    /// total
    @JsonKey(name: StoreCartShippingMethod.totalKey) required double total,

    /// subtotal
    @JsonKey(name: StoreCartShippingMethod.subtotalKey)
    required double subtotal,

    /// taxTotal
    @JsonKey(name: StoreCartShippingMethod.taxTotalKey)
    required double taxTotal,

    /// discountTotal
    @JsonKey(name: StoreCartShippingMethod.discountTotalKey)
    required double discountTotal,

    /// discountTaxTotal
    @JsonKey(name: StoreCartShippingMethod.discountTaxTotalKey)
