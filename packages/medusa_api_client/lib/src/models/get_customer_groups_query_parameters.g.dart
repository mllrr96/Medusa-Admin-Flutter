...
_GetCustomerGroupsQueryParameters _$GetCustomerGroupsQueryParametersFromJson(
...
Map<String, dynamic> _$GetCustomerGroupsQueryParametersToJson(
  _GetCustomerGroupsQueryParameters instance,
) => <String, dynamic>{
