...
part of 'base_region.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

_$BaseRegionImpl _$$BaseRegionImplFromJson(Map<String, dynamic> json) =>
    _$BaseRegionImpl(
...
Map<String, dynamic> _$$BaseRegionImplToJson(_$BaseRegionImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
