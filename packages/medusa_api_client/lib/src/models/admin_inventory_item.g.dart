...
_$AdminInventoryItemImpl _$$AdminInventoryItemImplFromJson(
  Map<String, dynamic> json,
) => _$AdminInventoryItemImpl(
...
Map<String, dynamic> _$$AdminInventoryItemImplToJson(
  _$AdminInventoryItemImpl instance,
) => <String, dynamic>{
  'id': instance.id,
  'sku': instance.sku,
