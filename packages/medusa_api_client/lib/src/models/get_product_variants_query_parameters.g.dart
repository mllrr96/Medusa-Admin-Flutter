...
_GetProductVariantsQueryParameters _$GetProductVariantsQueryParametersFromJson(
...
Map<String, dynamic> _$GetProductVariantsQueryParametersToJson(
  _GetProductVariantsQueryParameters instance,
) => <String, dynamic>{
