...
part of 'base_cart_line_item.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

_$BaseCartLineItemImpl _$$BaseCartLineItemImplFromJson(
  Map<String, dynamic> json,
) => _$BaseCartLineItemImpl(
  ...
  adjustments: (json['adjustments'] as List<dynamic>)
      .map((e) => BaseLineItemAdjustment.fromJson(e as Map<String, dynamic>))
      .toList(),
  cart: BaseCart.fromJson(json['cart'] as Map<String, dynamic>),
...
Map<String, dynamic> _$$BaseCartLineItemImplToJson(
  _$BaseCartLineItemImpl instance,
) => <String, dynamic>{
  'id': instance.id,
