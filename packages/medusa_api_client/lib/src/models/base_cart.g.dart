...
part of 'base_cart.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

_BaseCart _$BaseCartFromJson(Map<String, dynamic> json) => _BaseCart(
  id: json['id'] as String,
  region: BaseRegion.fromJson(json['region'] as Map<String, dynamic>),
  regionId: json['region_id'] as String,
  customerId: json['customer_id'] as String,
  salesChannelId: json['sales_channel_id'] as String,
  email: json['email'] as String,
  currencyCode: json['currency_code'] as String,
  shippingAddress: BaseCartAddress.fromJson(
    json['shipping_address'] as Map<String, dynamic>,
  ),
  billingAddress: BaseCartAddress.fromJson(
  ...
  shippingMethods: (json['shipping_methods'] as List<dynamic>)
      .map((e) => BaseCartShippingMethod.fromJson(e as Map<String, dynamic>))
      .toList(),
  paymentCollection: BasePaymentCollection.fromJson(
...
Map<String, dynamic> _$BaseCartToJson(_BaseCart instance) => <String, dynamic>{
  'id': instance.id,
