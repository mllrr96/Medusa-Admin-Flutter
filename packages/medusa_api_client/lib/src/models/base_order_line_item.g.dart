...
_$BaseOrderLineItemImpl _$$BaseOrderLineItemImplFromJson(
  Map<String, dynamic> json,
) => _$BaseOrderLineItemImpl(
...
Map<String, dynamic> _$$BaseOrderLineItemImplToJson(
  _$BaseOrderLineItemImpl instance,
) => <String, dynamic>{
  'id': instance.id,
