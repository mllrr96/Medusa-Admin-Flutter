...
/// }
library store_order_shipping_method;

import 'exports.dart';
part 'store_order_shipping_method.freezed.dart';
part 'store_order_shipping_method.g.dart'; // StoreOrderShippingMethod

@freezed
abstract class StoreOrderShippingMethod with _$StoreOrderShippingMethod {
  const StoreOrderShippingMethod._();

  @jsonSerializable
  const factory StoreOrderShippingMethod({
    /// id
    @JsonKey(name: StoreOrderShippingMethod.idKey) required String id,

    /// orderId
    @JsonKey(name: StoreOrderShippingMethod.orderIdKey) required String orderId,

    /// name
    @JsonKey(name: StoreOrderShippingMethod.nameKey) required String name,

    /// description
    @JsonKey(name: StoreOrderShippingMethod.descriptionKey)
    required String description,

    /// amount
    @JsonKey(name: StoreOrderShippingMethod.amountKey) required double amount,

    /// isTaxInclusive
    @JsonKey(name: StoreOrderShippingMethod.isTaxInclusiveKey)
    required bool isTaxInclusive,

    /// shippingOptionId
    @JsonKey(name: StoreOrderShippingMethod.shippingOptionIdKey)
    required String shippingOptionId,

    /// data
    @JsonKey(name: StoreOrderShippingMethod.dataKey)
    required Map<String, dynamic> data,

    /// metadata
    @JsonKey(name: StoreOrderShippingMethod.metadataKey)
    required Map<String, dynamic> metadata,

    /// taxLines
    @JsonKey(name: StoreOrderShippingMethod.taxLinesKey)
    required List<dynamic> taxLines,

    /// adjustments
    @JsonKey(name: StoreOrderShippingMethod.adjustmentsKey)
    required List<dynamic> adjustments,

    /// originalTotal
    @JsonKey(name: StoreOrderShippingMethod.originalTotalKey)
    required double originalTotal,

    /// originalSubtotal
    @JsonKey(name: StoreOrderShippingMethod.originalSubtotalKey)
    required double originalSubtotal,

    /// originalTaxTotal
    @JsonKey(name: StoreOrderShippingMethod.originalTaxTotalKey)
    required double originalTaxTotal,

    /// total
    @JsonKey(name: StoreOrderShippingMethod.totalKey) required double total,

    /// subtotal
    @JsonKey(name: StoreOrderShippingMethod.subtotalKey)
    required double subtotal,

    /// taxTotal
    @JsonKey(name: StoreOrderShippingMethod.taxTotalKey)
    required double taxTotal,

    /// discountTotal
    @JsonKey(name: StoreOrderShippingMethod.discountTotalKey)
    required double discountTotal,

    /// discountTaxTotal
    @JsonKey(name: StoreOrderShippingMethod.discountTaxTotalKey)
    required double discountTaxTotal,

    /// createdAt
    @JsonKey(name: StoreOrderShippingMethod.createdAtKey)
    required DateTime createdAt,

    /// updatedAt
    @JsonKey(name: StoreOrderShippingMethod.updatedAtKey)
    required DateTime updatedAt,

    /// detail
    @JsonKey(name: StoreOrderShippingMethod.detailKey) required dynamic detail,
