...
_$StoreShippingOptionImpl _$$StoreShippingOptionImplFromJson(
  Map<String, dynamic> json,
) => _$StoreShippingOptionImpl(
  ...
  type: StoreShippingOptionType.fromJson(json['type'] as Map<String, dynamic>),
...
Map<String, dynamic> _$$StoreShippingOptionImplToJson(
  _$StoreShippingOptionImpl instance,
) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
