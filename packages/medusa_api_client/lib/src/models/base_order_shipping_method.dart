...
/// }
library base_order_shipping_method;

import 'exports.dart';
part 'base_order_shipping_method.freezed.dart';
part 'base_order_shipping_method.g.dart'; // BaseOrderShippingMethod

@freezed
abstract class BaseOrderShippingMethod with _$BaseOrderShippingMethod {
  const BaseOrderShippingMethod._();

  @jsonSerializable
  const factory BaseOrderShippingMethod({
    /// id
    @JsonKey(name: BaseOrderShippingMethod.idKey) required String id,

    /// orderId
    @JsonKey(name: BaseOrderShippingMethod.orderIdKey) required String orderId,

    /// name
    @JsonKey(name: BaseOrderShippingMethod.nameKey) required String name,

    /// description
    @JsonKey(name: BaseOrderShippingMethod.descriptionKey)
    required String description,

    /// amount
    @JsonKey(name: BaseOrderShippingMethod.amountKey) required double amount,

    /// isTaxInclusive
    @JsonKey(name: BaseOrderShippingMethod.isTaxInclusiveKey)
    required bool isTaxInclusive,

    /// shippingOptionId
    @JsonKey(name: BaseOrderShippingMethod.shippingOptionIdKey)
    required String shippingOptionId,

    /// data
    @JsonKey(name: BaseOrderShippingMethod.dataKey)
    required Map<String, dynamic> data,

    /// metadata
    @JsonKey(name: BaseOrderShippingMethod.metadataKey)
    required Map<String, dynamic> metadata,

    /// taxLines
    @JsonKey(name: BaseOrderShippingMethod.taxLinesKey)
    required List<BaseOrderShippingMethodTaxLine> taxLines,

    /// adjustments
    @JsonKey(name: BaseOrderShippingMethod.adjustmentsKey)
    required List<BaseOrderShippingMethodAdjustment> adjustments,

    /// originalTotal
    @JsonKey(name: BaseOrderShippingMethod.originalTotalKey)
    required double originalTotal,

    /// originalSubtotal
    @JsonKey(name: BaseOrderShippingMethod.originalSubtotalKey)
    required double originalSubtotal,

    /// originalTaxTotal
    @JsonKey(name: BaseOrderShippingMethod.originalTaxTotalKey)
    required double originalTaxTotal,

    /// total
    @JsonKey(name: BaseOrderShippingMethod.totalKey) required double total,

    /// subtotal
    @JsonKey(name: BaseOrderShippingMethod.subtotalKey)
    required double subtotal,

    /// taxTotal
    @JsonKey(name: BaseOrderShippingMethod.taxTotalKey)
    required double taxTotal,

    /// discountTotal
    @JsonKey(name: BaseOrderShippingMethod.discountTotalKey)
    required double discountTotal,

    /// discountTaxTotal
    @JsonKey(name: BaseOrderShippingMethod.discountTaxTotalKey)
    required double discountTaxTotal,

    /// createdAt
    @JsonKey(name: BaseOrderShippingMethod.createdAtKey)
    required DateTime createdAt,

    /// updatedAt
    @JsonKey(name: BaseOrderShippingMethod.updatedAtKey)
    required DateTime updatedAt,

    /// detail
    @JsonKey(name: BaseOrderShippingMethod.detailKey)
    required BaseOrderShippingDetail detail,
  }) = _BaseOrderShippingMethod;

  factory BaseOrderShippingMethod.fromJson(Map<String, dynamic> json) =>
      _$BaseOrderShippingMethodFromJson(json);
