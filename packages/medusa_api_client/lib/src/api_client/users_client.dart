...
abstract class UsersClient {
  ...
  Future<HttpResponse<AdminUserListResponse>> getUsers({
    @Queries() required GetUsersQueryParameters queries,
  ...
  Future<HttpResponse<AdminUserResponse>> getUsersId({
    @Queries() required GetUsersIdQueryParameters queries,
  ...
  Future<HttpResponse<AdminUserResponse>> postUsersId({
    @Body() required AdminUpdateUser requestBody,
    @Queries() required PostUsersIdQueryParameters queries,
    @Path("id") required String id,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
