...
part 'product_variants_client.g.dart';

@RestApi()
abstract class ProductVariantsClient {
  factory ProductVariantsClient(
    Dio dio, {
    ParseErrorLogger? errorLogger,
    String? baseUrl,
  }) = _ProductVariantsClient;
  ...
  Future<HttpResponse<dynamic>> getProductVariants({
    @Queries() required GetProductVariantsQueryParameters queries,
