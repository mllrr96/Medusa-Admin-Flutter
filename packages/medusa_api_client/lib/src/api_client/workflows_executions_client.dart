...
@RestApi()
abstract class WorkflowsExecutionsClient {
  factory WorkflowsExecutionsClient(
    Dio dio, {
    ParseErrorLogger? errorLogger,
    String? baseUrl,
  }) = _WorkflowsExecutionsClient;
  ...
  Future<HttpResponse<dynamic>> getWorkflowsExecutions({
    @Queries() required GetWorkflowsExecutionsQueryParameters queries,
  ...
  getWorkflowsExecutionsId({
    @Queries() required GetWorkflowsExecutionsIdQueryParameters queries,
  ...
  Future<HttpResponse> getWorkflowsExecutionsWorkflowIdSubscribe({
    @Path("workflow_id") required String workflowId,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
