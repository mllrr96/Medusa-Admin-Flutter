...
part of 'workflows_executions_client.dart';
...
class _WorkflowsExecutionsClient implements WorkflowsExecutionsClient {
  _WorkflowsExecutionsClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<HttpResponse<dynamic>> getWorkflowsExecutions({
    required GetWorkflowsExecutionsQueryParameters queries,
  ...
  @override
  Future<HttpResponse<AdminWorkflowExecutionResponse>>
  getWorkflowsExecutionsId({
    required GetWorkflowsExecutionsIdQueryParameters queries,
    required String id,
    Map<String, dynamic>? extras,
    CancelToken? cancelToken,
    void Function(int, int)? onSendProgress,
    ...
    const Map<String, dynamic>? _data = null;
    final _options =
        _setStreamType<HttpResponse<AdminWorkflowExecutionResponse>>(
          Options(method: 'GET', headers: _headers, extra: _extra)
              .compose(
                _dio.options,
    ...
    late AdminWorkflowExecutionResponse _value;
    try {
      _value = AdminWorkflowExecutionResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<HttpResponse<dynamic>> getWorkflowsExecutionsWorkflowIdSubscribe({
    required String workflowId,
    Map<String, dynamic>? extras,
    CancelToken? cancelToken,
    void Function(int, int)? onSendProgress,
  ...
  @override
  Future<HttpResponse<AdminWorkflowExecutionResponse>>
  getWorkflowsExecutionsWorkflowIdTransactionId({
    required GetWorkflowsExecutionsWorkflowIdTransactionIdQueryParameters
    queries,
    required String workflowId,
