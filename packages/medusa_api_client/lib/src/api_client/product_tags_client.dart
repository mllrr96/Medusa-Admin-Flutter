...
part 'product_tags_client.g.dart';

@RestApi()
abstract class ProductTagsClient {
  factory ProductTagsClient(
    Dio dio, {
  ...
  Future<HttpResponse<AdminProductTagListResponse>> getProductTags({
    @Queries() required GetProductTagsQueryParameters queries,
  ...
  Future<HttpResponse<AdminProductTagResponse>> postProductTags({
    @Body() required AdminCreateProductTag requestBody,
    @Queries() required PostProductTagsQueryParameters queries,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
    @ReceiveProgress() ProgressCallback? onReceiveProgress,
  ...
  Future<HttpResponse<AdminProductTagResponse>> getProductTagsId({
    @Queries() required GetProductTagsIdQueryParameters queries,
  ...
  Future<HttpResponse<AdminProductTagResponse>> postProductTagsId({
    ...
    @Queries() required PostProductTagsIdQueryParameters queries,
    @Path("id") required String id,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
