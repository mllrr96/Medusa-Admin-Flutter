...
class _ExchangesClient implements ExchangesClient {
  _ExchangesClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<dynamic>> getExchanges({
    required GetExchangesQueryParameters queries,
  ...
  Future<HttpResponse<AdminExchangeOrderResponse>> postExchanges({
    required AdminPostOrderExchangesReqSchema requestBody,
    required PostExchangesQueryParameters queries,
    Map<String, dynamic>? extras,
    CancelToken? cancelToken,
    void Function(int, int)? onSendProgress,
    void Function(int, int)? onReceiveProgress,
    ...
    final _options = _setStreamType<HttpResponse<AdminExchangeOrderResponse>>(
    ...
    late AdminExchangeOrderResponse _value;
    try {
      _value = AdminExchangeOrderResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<HttpResponse<AdminExchangeResponse>> getExchangesId({
    required GetExchangesIdQueryParameters queries,
    required String id,
    Map<String, dynamic>? extras,
    CancelToken? cancelToken,
    void Function(int, int)? onSendProgress,
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<AdminExchangeResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/exchanges/${id}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AdminExchangeResponse _value;
    try {
      _value = AdminExchangeResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<AdminExchangeResponse>> postExchangesIdCancel({
    required AdminPostCancelExchangeReqSchema requestBody,
    required String id,
    Map<String, dynamic>? extras,
    CancelToken? cancelToken,
    void Function(int, int)? onSendProgress,
  ...
  postExchangesIdInboundItems({
    required AdminPostExchangesReturnRequestItemsReqSchema requestBody,
    required String id,
    Map<String, dynamic>? extras,
    CancelToken? cancelToken,
    void Function(int, int)? onSendProgress,
    ...
    final _data = <String, dynamic>{};
    _data.addAll(requestBody.toJson());
    final _options = _setStreamType<HttpResponse<AdminExchangeReturnResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AdminExchangeReturnResponse _value;
    try {
      _value = AdminExchangeReturnResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  postExchangesIdInboundShippingMethodActionId({
    required AdminPostExchangesShippingActionReqSchema requestBody,
    ...
    final _data = <String, dynamic>{};
    _data.addAll(requestBody.toJson());
    final _options = _setStreamType<HttpResponse<AdminExchangePreviewResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AdminExchangePreviewResponse _value;
    try {
      _value = AdminExchangePreviewResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  postExchangesIdOutboundItems({
    required AdminPostExchangesAddItemsReqSchema requestBody,
    required PostExchangesIdOutboundItemsQueryParameters queries,
    required String id,
    Map<String, dynamic>? extras,
    CancelToken? cancelToken,
    void Function(int, int)? onSendProgress,
  ...
  postExchangesIdOutboundItemsActionId({
    required AdminPostExchangesItemsActionReqSchema requestBody,
  ...
  postExchangesIdOutboundShippingMethod({
    required AdminPostExchangesShippingReqSchema requestBody,
  ...
  Future<HttpResponse<AdminExchangeRequestResponse>> postExchangesIdRequest({
    required PostExchangesIdRequestQueryParameters queries,
    required String id,
    Map<String, dynamic>? extras,
    CancelToken? cancelToken,
    void Function(int, int)? onSendProgress,
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<AdminExchangeRequestResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AdminExchangeRequestResponse _value;
    try {
      _value = AdminExchangeRequestResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<AdminExchangeDeleteResponse>> deleteExchangesIdRequest({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<AdminExchangeDeleteResponse>>(
      Options(method: 'DELETE', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/exchanges/${id}/request',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AdminExchangeDeleteResponse _value;
    try {
      _value = AdminExchangeDeleteResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
