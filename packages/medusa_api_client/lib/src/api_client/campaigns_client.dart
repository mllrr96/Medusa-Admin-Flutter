...
@RestApi()
abstract class CampaignsClient {
  factory CampaignsClient(
    Dio dio, {
  ...
  Future<HttpResponse<dynamic>> getCampaigns({
    @Queries() required GetCampaignsQueryParameters queries,
  ...
  Future<HttpResponse<AdminCampaignResponse>> postCampaigns({
    ...
    @Queries() required PostCampaignsQueryParameters queries,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
    @ReceiveProgress() ProgressCallback? onReceiveProgress,
  ...
  Future<HttpResponse<AdminCampaignResponse>> getCampaignsId({
    @Queries() required GetCampaignsIdQueryParameters queries,
  ...
  Future<HttpResponse<AdminCampaignResponse>> postCampaignsId({
    @Body() required dynamic requestBody,
    @Queries() required PostCampaignsIdQueryParameters queries,
    @Path("id") required String id,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
  ...
  Future<HttpResponse<AdminCampaignResponse>> postCampaignsIdPromotions({
    ...
    @Queries() required PostCampaignsIdPromotionsQueryParameters queries,
    @Path("id") required String id,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
