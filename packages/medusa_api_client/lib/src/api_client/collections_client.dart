...
part 'collections_client.g.dart';

@RestApi()
abstract class CollectionsClient {
  factory CollectionsClient(
    Dio dio, {
  ...
  Future<HttpResponse<AdminCollectionListResponse>> getCollections({
    @Queries() required GetCollectionsQueryParameters queries,
  ...
  Future<HttpResponse<AdminCollectionResponse>> postCollections({
    ...
    @Queries() required PostCollectionsQueryParameters queries,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
    @ReceiveProgress() ProgressCallback? onReceiveProgress,
  ...
  Future<HttpResponse<AdminCollectionResponse>> getCollectionsId({
    @Queries() required GetCollectionsIdQueryParameters queries,
  ...
  Future<HttpResponse<AdminCollectionResponse>> postCollectionsId({
    @Body() required dynamic requestBody,
    @Queries() required PostCollectionsIdQueryParameters queries,
    @Path("id") required String id,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
  ...
  Future<HttpResponse<AdminCollectionResponse>> postCollectionsIdProducts({
    ...
    @Queries() required PostCollectionsIdProductsQueryParameters queries,
    @Path("id") required String id,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
