...
part 'product_types_client.g.dart';

@RestApi()
abstract class ProductTypesClient {
  factory ProductTypesClient(
    Dio dio, {
  ...
  Future<HttpResponse<AdminProductTypeListResponse>> getProductTypes({
    @Queries() required GetProductTypesQueryParameters queries,
  ...
  Future<HttpResponse<AdminProductTypeResponse>> postProductTypes({
    @Body() required AdminCreateProductType requestBody,
    @Queries() required PostProductTypesQueryParameters queries,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
    @ReceiveProgress() ProgressCallback? onReceiveProgress,
  ...
  Future<HttpResponse<AdminProductTypeResponse>> getProductTypesId({
    @Queries() required GetProductTypesIdQueryParameters queries,
  ...
  Future<HttpResponse<AdminProductTypeResponse>> postProductTypesId({
    ...
    @Queries() required PostProductTypesIdQueryParameters queries,
    @Path("id") required String id,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
