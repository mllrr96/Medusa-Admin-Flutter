...
part 'price_preferences_client.g.dart';

@RestApi()
abstract class PricePreferencesClient {
  factory PricePreferencesClient(
    Dio dio, {
    ParseErrorLogger? errorLogger,
    String? baseUrl,
  }) = _PricePreferencesClient;
  ...
  Future<HttpResponse<AdminPricePreferenceListResponse>> getPricePreferences({
    @Queries() required GetPricePreferencesQueryParameters queries,
  ...
  Future<HttpResponse<AdminPricePreferenceResponse>> postPricePreferences({
    @Body() required AdminCreatePricePreference requestBody,
    @Queries() required PostPricePreferencesQueryParameters queries,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
    @ReceiveProgress() ProgressCallback? onReceiveProgress,
  ...
  Future<HttpResponse<AdminPricePreferenceResponse>> getPricePreferencesId({
    @Queries() required GetPricePreferencesIdQueryParameters queries,
  ...
  Future<HttpResponse<AdminPricePreferenceResponse>> postPricePreferencesId({
    @Body() required AdminUpdatePricePreference requestBody,
    @Queries() required PostPricePreferencesIdQueryParameters queries,
    @Path("id") required String id,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
