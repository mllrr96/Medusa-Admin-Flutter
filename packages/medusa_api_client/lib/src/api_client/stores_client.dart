...
part 'stores_client.g.dart';

@RestApi()
abstract class StoresClient {
  factory StoresClient(
    Dio dio, {
  ...
  Future<HttpResponse<AdminStoreListResponse>> getStores({
    @Queries() required GetStoresQueryParameters queries,
  ...
  Future<HttpResponse<AdminStoreResponse>> getStoresId({
    @Queries() required GetStoresIdQueryParameters queries,
  ...
  Future<HttpResponse<AdminStoreResponse>> postStoresId({
    @Body() required AdminUpdateStore requestBody,
    @Queries() required PostStoresIdQueryParameters queries,
    @Path("id") required String id,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
