...
abstract class ReservationsClient {
  ...
  Future<HttpResponse<dynamic>> getReservations({
    @Queries() required GetReservationsQueryParameters queries,
  ...
  Future<HttpResponse<AdminReservationResponse>> postReservations({
    @Body() required AdminCreateReservation requestBody,
    @Queries() required PostReservationsQueryParameters queries,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
    @ReceiveProgress() ProgressCallback? onReceiveProgress,
  ...
  Future<HttpResponse<AdminReservationResponse>> getReservationsId({
    @Queries() required GetReservationsIdQueryParameters queries,
  ...
  Future<HttpResponse<AdminReservationResponse>> postReservationsId({
    ...
    @Queries() required PostReservationsIdQueryParameters queries,
    @Path("id") required String id,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
