...
part 'payment_collections_client.g.dart';

@RestApi()
abstract class PaymentCollectionsClient {
  factory PaymentCollectionsClient(
    Dio dio, {
    ParseErrorLogger? errorLogger,
    String? baseUrl,
  }) = _PaymentCollectionsClient;
  ...
  Future<HttpResponse<AdminPaymentCollectionResponse>> postPaymentCollections({
    ...
    @Queries() required PostPaymentCollectionsQueryParameters queries,
