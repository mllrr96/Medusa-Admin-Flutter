...
part 'order_edits_client.g.dart';

@RestApi()
abstract class OrderEditsClient {
  factory OrderEditsClient(
    Dio dio, {
  ...
  Future<HttpResponse<AdminOrderEditResponse>> postOrderEdits({
    @Body() required AdminPostOrderEditsReqSchema requestBody,
  ...
  Future<HttpResponse<AdminOrderEditPreviewResponse>> postOrderEditsIdItems({
    @Body() required AdminPostOrderEditsAddItemsReqSchema requestBody,
    @Path("id") required String id,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
  ...
  postOrderEditsIdItemsItemItemId({
    @Body() required AdminPostOrderEditsUpdateItemQuantityReqSchema requestBody,
    @Path("id") required String id,
  ...
  postOrderEditsIdItemsActionId({
    @Body() required AdminPostOrderEditsItemsActionReqSchema requestBody,
    @Path("id") required String id,
  ...
  postOrderEditsIdShippingMethod({
    @Body() required AdminPostOrderEditsShippingReqSchema requestBody,
    @Path("id") required String id,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
  ...
  postOrderEditsIdShippingMethodActionId({
    @Body() required AdminPostOrderEditsShippingActionReqSchema requestBody,
    @Path("id") required String id,
    @Path("action_id") required String actionId,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
