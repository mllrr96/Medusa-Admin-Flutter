...
part 'product_categories_client.g.dart';

@RestApi()
abstract class ProductCategoriesClient {
  factory ProductCategoriesClient(
    Dio dio, {
    ParseErrorLogger? errorLogger,
    String? baseUrl,
  }) = _ProductCategoriesClient;
  ...
  Future<HttpResponse<AdminProductCategoryListResponse>> getProductCategories({
    @Queries() required GetProductCategoriesQueryParameters queries,
  ...
  Future<HttpResponse<AdminProductCategoryResponse>> postProductCategories({
    @Body() required AdminCreateProductCategory requestBody,
    @Queries() required PostProductCategoriesQueryParameters queries,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
    @ReceiveProgress() ProgressCallback? onReceiveProgress,
  ...
  Future<HttpResponse<AdminProductCategoryResponse>> getProductCategoriesId({
    @Queries() required GetProductCategoriesIdQueryParameters queries,
  ...
  Future<HttpResponse<AdminProductCategoryResponse>> postProductCategoriesId({
    ...
    @Queries() required PostProductCategoriesIdQueryParameters queries,
    @Path("id") required String id,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
  ...
  postProductCategoriesIdProducts({
    @Body() required Map<String, dynamic> requestBody,
    @Queries() required PostProductCategoriesIdProductsQueryParameters queries,
    @Path("id") required String id,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
