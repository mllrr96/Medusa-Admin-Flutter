...
@RestApi()
abstract class InventoryItemsClient {
  factory InventoryItemsClient(
    Dio dio, {
    ParseErrorLogger? errorLogger,
    String? baseUrl,
  }) = _InventoryItemsClient;
  ...
  Future<HttpResponse<dynamic>> getInventoryItems({
    @Queries() required GetInventoryItemsQueryParameters queries,
  ...
  Future<HttpResponse<AdminInventoryItemResponse>> postInventoryItems({
    @Body() required AdminCreateInventoryItem requestBody,
    @Queries() required PostInventoryItemsQueryParameters queries,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
    @ReceiveProgress() ProgressCallback? onReceiveProgress,
  ...
  postInventoryItemsLocationLevelsBatch({
    @Body() required AdminBatchInventoryItemsLocationLevels requestBody,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
    @ReceiveProgress() ProgressCallback? onReceiveProgress,
  ...
  Future<HttpResponse<AdminInventoryItemResponse>> getInventoryItemsId({
    @Queries() required GetInventoryItemsIdQueryParameters queries,
  ...
  Future<HttpResponse<AdminInventoryItemResponse>> postInventoryItemsId({
    ...
    @Queries() required PostInventoryItemsIdQueryParameters queries,
    @Path("id") required String id,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
  ...
  Future<HttpResponse> postInventoryItemsIdLocationLevelsBatch({
    @Body() required AdminBatchInventoryItemLocationsLevel requestBody,
    @Path("id") required String id,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
