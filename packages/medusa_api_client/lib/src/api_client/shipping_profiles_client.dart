...
part 'shipping_profiles_client.g.dart';

@RestApi()
abstract class ShippingProfilesClient {
  factory ShippingProfilesClient(
    Dio dio, {
    ParseErrorLogger? errorLogger,
    String? baseUrl,
  }) = _ShippingProfilesClient;
  ...
  Future<HttpResponse<dynamic>> getShippingProfiles({
    @Queries() required GetShippingProfilesQueryParameters queries,
  ...
  Future<HttpResponse<AdminShippingProfileResponse>> postShippingProfiles({
    @Body() required AdminCreateShippingProfile requestBody,
    @Queries() required PostShippingProfilesQueryParameters queries,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
    @ReceiveProgress() ProgressCallback? onReceiveProgress,
  ...
  Future<HttpResponse<AdminShippingProfileResponse>> getShippingProfilesId({
    @Queries() required GetShippingProfilesIdQueryParameters queries,
  ...
  Future<HttpResponse<AdminShippingProfileResponse>> postShippingProfilesId({
    ...
    @Queries() required PostShippingProfilesIdQueryParameters queries,
    @Path("id") required String id,
    @Extras() Map<String, dynamic>? extras,
    @CancelRequest() CancelToken? cancelToken,
    @SendProgress() ProgressCallback? onSendProgress,
