        ...
        return GestureDetector(
          ...
          child: Scaffold(
            appBar: AppBar(
              ...
              actions: [
                AdaptiveButton(
                    onPressed: () async => controller.updateMode ? await controller.updateGiftCard: await controller.createGiftCard(),
                            ...
                            LabeledTextField(
                              ...
                              onTap: () async {
                                final regionReq = PickRegionsReq(
                                  ...
                                  selectedRegions: controller.selectedRegion != null ? [controller.selectedRegion!] : [],
                                );
