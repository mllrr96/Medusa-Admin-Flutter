  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        actions: [TextButton(onPressed: () {}, child: const Text('Publish'))],
      ),
      body: SafeArea(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              space,
              ProductTextField(
                  label: 'Title', controller: TextEditingController(), required: true, hintText: 'Sunglasses'),
              ProductTextField(label: 'Handle', controller: TextEditingController(), hintText: '/sunglasses'),
              Row(
                children: [
