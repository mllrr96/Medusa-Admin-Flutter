...
class _ChooseShippingOptionViewState extends State<ChooseShippingOptionView> {
  @override
  void initState() {
    ChooseShippingOptionController.instance.loadShippingMethods(
        widget.region.id!);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    const space = Gap(12);
    return GetBuilder<ChooseShippingOptionController>(
        init: ChooseShippingOptionController(
                  ...
                  DropdownButtonFormField<ShippingOption>(
                    ...
                    items: state!
                        ...
                        DropdownMenuItem(
                            ...
                            .formatAsPrice(e.region?.currencyCode)}')))
                        .toList(),
                      ...
                      children: [
                        Flexible(
                            child: LabeledTextField(
                              ...
                              controller: TextEditingController(text: widget
                                  .region.currencyCode?.toUpperCase()),
                            )),
                        ...
                        Flexible(
                            ...
                            child: LabeledNumericTextField(
                              ...
                              onChanged: (val) {
                                final customPrice = val.replaceAll('.', '')
                                    .replaceAll(',', '');
