...
class OrderDetailsBinding extends Bindings {
  ...
  void dependencies() {
    Get.lazyPut<OrderDetailsController>(
        () => OrderDetailsController(ordersRepo: OrdersRepo(), orderEditsRepo: OrderEditRepo(), noteRepo: NoteRepo(), notificationRepo: NotificationRepo(), fulfillmentRepo: FulfillmentRepo()));
  }
}
