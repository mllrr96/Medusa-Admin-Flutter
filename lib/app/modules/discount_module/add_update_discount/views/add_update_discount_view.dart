...
class AddUpdateDiscountView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<AddUpdateDiscountController>(
        init: AddUpdateDiscountController(discountRepo: DiscountRepo(), discount: discount),
        builder: (controller) {
      return WillPopScope(
        onWillPop: () async {
              ...
              child: SingleChildScrollView(
                ...
                child: Padding(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      children: [
                        if (!controller.updateMode) DiscountTypeExpansionTile(
                            context),
                        ...
                        space,
                        if (!controller.updateMode) ConditionExpansionTile(
                            context),
                      ],
                    ),
                  ),
