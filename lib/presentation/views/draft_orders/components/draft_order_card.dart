              ...
              Row(
                ...
                children: [
                  ...
                  if (draftOrder.order?.displayId != null)
                    Text('Order #${draftOrder.order!.displayId}',
                  ...
                  Flexible(
                    child: Row(
                      children: [
                        CircleAvatar(
                          backgroundColor: shimmer
                              ...
                              : ColorManager.getAvatarColor(
                                  draftOrder.cart?.email),
                          radius: 16,
                          child: shimmer
                              ? null
                              : Text(
                                  customerName?[0].capitalize ??
                                      draftOrder.cart?.email?[0].capitalize ??
                                      '',
                        ...
                        if (customerName == null)
                          Flexible(
                              child: Text(draftOrder.cart?.email ?? '',
                                  style: mediumTextStyle)),
                      ],
                    ),
                  ),
...
class ShadDraftOrderCard extends StatelessWidget {
  const ShadDraftOrderCard(this.draftOrder,
      {super.key, this.onTap, this.shimmer = false});
  final DraftOrder draftOrder;
  final void Function()? onTap;
  final bool shimmer;
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  ShadDraftOrderStatusLabel(draftOrder.status!),
                ],
              ),
            ],
          ),
