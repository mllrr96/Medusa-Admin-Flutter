...
class _DiscountDetailsViewState extends State<DiscountDetailsView> {
  ...
  Widget build(BuildContext context) {
    ...
    const space = Gap(12);
    return BlocProvider(
      create: (context) => discountCrudBloc,
      child: BlocConsumer<DiscountCrudBloc, DiscountCrudState>(
                ...
                discount: (state) => SmartRefresher(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      space,
                      ConfigurationsCard(state.discount, shadStyle: true),
                      space,
                      ConditionsCard(state.discount, shadStyle: true),
                    ],
                  ),
                ),
