...
class CustomShadCheckbox extends StatefulWidget {
  const CustomShadCheckbox({
    super.key,
    required this.value,
    this.enabled = true,
    this.onChanged,
  ...
  @override
  State<CustomShadCheckbox> createState() => _CustomShadCheckboxState();
}

class _CustomShadCheckboxState extends State<CustomShadCheckbox> {
    ...
    return ShadDisabled(
      ...
      child: GestureDetector(
        ...
        child: Row(
          ...
          crossAxisAlignment: widget.sublabel != null
