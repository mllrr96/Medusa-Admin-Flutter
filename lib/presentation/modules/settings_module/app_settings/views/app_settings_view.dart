      ...
      builder: (controller) {
        ...
        return Scaffold(
          ...
          body: SettingsList(
            ...
            sections: [
              SettingsSection(title: const Text('Authentication '), tiles: [
                SettingsTile.switchTile(
                  ...
                  onToggle: controller.canCheckBiometrics == null
                      ...
                      : (enableBiometric) async {
                          final isAuthenticated =
                              await controller.localAuthentication.authenticate(
                                  localizedReason:
                                      'Please authenticate to ${enableBiometric ? 'enable' : 'disable'} biometric auth');
                          if (!isAuthenticated) return;

                          if (enableBiometric && context.mounted) {
                            ...
                            if (result == OkCancelResult.ok) {
                              ...
                              await result.when((success) async {
                                ...
                                if (error.code == 401) {
                                  ...
                                  context
                                      .showSnackBar(error.toSnackBarString());
                                }
                              });
                            }
                          } else {
                  ...
                  description: controller.canCheckBiometrics == false
                      ? const Text(
