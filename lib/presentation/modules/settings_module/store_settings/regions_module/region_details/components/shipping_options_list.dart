...
class ShippingOptionsList extends GetView<RegionDetailsController> {
  const ShippingOptionsList(this.region, {super.key});
  final Region region;
  @override
  Widget build(BuildContext context) {
    return FutureBuilder<List<ShippingOption>?>(
        future: controller.shippingOptionsFuture,
