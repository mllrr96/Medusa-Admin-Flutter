...
class PaymentProvidersState with _$PaymentProvidersState {
  ...
  const factory PaymentProvidersState.paymentProviders(
      List<PaymentProvider> paymentProviders) = _PaymentProviders;
  const factory PaymentProvidersState.error(MedusaError failure) = _Error;
}
