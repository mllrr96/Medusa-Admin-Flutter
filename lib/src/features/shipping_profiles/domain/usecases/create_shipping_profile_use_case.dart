...
@lazySingleton
class CreateShippingProfileUseCase {
  final MedusaAdminV2 _medusaAdmin;

  CreateShippingProfileUseCase(this._medusaAdmin);

  ShippingProfilesRepository get _shippingProfilesRepository => _medusaAdmin.shippingProfiles;

  static CreateShippingProfileUseCase get instance => getIt<CreateShippingProfileUseCase>();
