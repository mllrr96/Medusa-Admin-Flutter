...
class RegionCrudEvent with _$RegionCrudEvent {
  ...
  const factory RegionCrudEvent.create(CreateRegionReq userCreateRegionReq) =
      _Create;
  ...
  const factory RegionCrudEvent.addFulfillmentProvider(
      String id, String providerId) = _AddFulfillmentProvider;
  const factory RegionCrudEvent.removeFulfillmentProvider(
      String id, String providerId) = _RemoveFulfillmentProvider;
  const factory RegionCrudEvent.addPaymentProvider(
      String id, String providerId) = _AddPaymentProvider;
  const factory RegionCrudEvent.removePaymentProvider(
      String id, String providerId) = _RemovePaymentProvider;
}
