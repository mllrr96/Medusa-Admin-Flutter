...
class ProductVariantsState with _$ProductVariantsState {
  ...
  const factory ProductVariantsState.variants(
      List<ProductVariant> variants, int count) = _Variants;
  const factory ProductVariantsState.error(MedusaError failure) = _Error;
}
