...
class DiscountCrudState with _$DiscountCrudState {
  ...
  const factory DiscountCrudState.discount(Promotion discount) = _Discount;
  const factory DiscountCrudState.discounts(List<Promotion> discounts, int count) = _Discounts;
  const factory DiscountCrudState.error(MedusaError failure) = _Error;
