...
class ShippingOptionTypesState with _$ShippingOptionTypesState {
  ...
  const factory ShippingOptionTypesState.optionTypes(ShippingOptionListRes optionTypes) = _OptionTypes;
  const factory ShippingOptionTypesState.option(ShippingOption option) = _Option;
