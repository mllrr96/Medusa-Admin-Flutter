...
class CustomerCrudEvent with _$CustomerCrudEvent {
  const factory CustomerCrudEvent.create(CustomerCreateReq userCreateCustomerReq) = _Create;

  const factory CustomerCrudEvent.update(String id, CustomerUpdateReq userUpdateCustomerReq) =
      _Update;
