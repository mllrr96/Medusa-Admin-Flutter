...
class ReturnReasonsCrudState with _$ReturnReasonsCrudState {
  ...
  const factory ReturnReasonsCrudState.returnReason(ReturnReason returnReason) =
      _ReturnReason;
  const factory ReturnReasonsCrudState.returnReasons(
      List<ReturnReason> returnReasons, int count) = _ReturnReasons;
