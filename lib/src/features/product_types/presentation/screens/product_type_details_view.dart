...
@RoutePage()
class ProductTypeDetailsView extends StatefulWidget {
  const ProductTypeDetailsView(this.productType, {super.key});
  final ProductType productType;

  @override
  State<ProductTypeDetailsView> createState() => _ProductTypeDetailsViewState();
}

class _ProductTypeDetailsViewState extends State<ProductTypeDetailsView> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<ProductCrudBloc, ProductCrudState>(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(widget.productType.value),
        ),
        body: SafeArea(
