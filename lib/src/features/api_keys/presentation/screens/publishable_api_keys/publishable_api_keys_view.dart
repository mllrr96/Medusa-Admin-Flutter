...
@RoutePage()
class PublishableApiKeysView extends StatefulWidget {
  const PublishableApiKeysView({super.key});

  @override
  State<PublishableApiKeysView> createState() => _PublishableApiKeysViewState();
}
...
class _PublishableApiKeysViewState extends State<PublishableApiKeysView> {
  ...
  void _loadPage(int page) {
    apiKeyCrudBloc.add(ApiKeyCrudEvent.loadAll(queryParameters: {
      ...
      'type': ApiKeyType.publishable.name,
    }));
  }
    ...
    return BlocListener<ApiKeyCrudBloc, ApiKeyCrudState>(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () => context.pushRoute(AddUpdateApiKeyRoute(type: ApiKeyType.publishable)),
